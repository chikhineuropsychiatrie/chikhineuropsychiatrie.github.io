...
"""
    ...
    SERVICES = [
        ("brain", "الطب العصبي النفسي",
         "تشخيص الاضطرابات العصبية والنفسية والتكفل بها: الاكتئاب، القلق، الاضطراب ثنائي القطب، الصرع، الصداع، الإدمان على المخدرات الخفيفة."),
        ("chat", "العلاج النفسي",
...
<section>
  <div class="wrap">
    <div class="section-head">
      ...
      <h2>مجالات التكفل</h2>
      <p>التوتر، القلق، الاكتئاب، الاضطراب ثنائي القطب، الصرع، الصداع، الإدمان على المخدرات الخفيفة، وغيرها من الاضطرابات النفسية والعصبية.</p>
    </div>
{cards(SERVICES)}
  </div>
</section>
    ...
    <div class="split">
      <div class="body">
        ...
        <p>
          ...
          الصرع، الصداع، الإدمان على المخدرات الخفيفة، وغيرها من الاضطرابات النفسية أو العصبية.
        </p>
        <p>{CONFIANCE}</p>
      </div>
      <figure class="media">
